...
function setup() {
  ...
  frameRate(20);
  newGrassColour = color(180, 188, 204);
  grassColour = color(199, 245, 101);
  //color(84, 111, 28);
  stemColour = color(84, 111, 28);
  //color(135, 124, 98);
  ...
  p4 = new Plant(windowWidth * random(0.1, 0.7), windowHeight);
  p5 = new Plant(windowWidth * random(0.6, 0.9), windowHeight);
...
class Stem extends Node {
  ...
  draw() {
    if (!isScrolling){
      ...
      strokeWeight(this.width);
      stroke(lerpColor(newGrassColour, stemColour, this.length / minBranchLength));
      line(this.parent.pos.x, this.parent.pos.y, this.pos.x, this.pos.y);
    }
  }
}
